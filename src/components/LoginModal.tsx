      ...
      >
        ...
        <div className="p-6 space-y-4">
          <form onSubmit={handleSubmit} className="space-y-3.5">
            <div>
              <label htmlFor="login-gmail-input" className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="VD: sherlockramosreal@gmail.com"
                  autoFocus
            ...
            <div>
              <label htmlFor="login-name-input" className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">
              ...
              <input
                ...
                placeholder="VD: Sherlock Ramos, Tuấn Anh..."
          ...
          <div className="pt-3 border-t border-slate-100 dark:border-slate-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <button
                type="button"
                id="quick-select-sherlock-btn"
                onClick={() => handleQuickSelect('Sherlock Ramos', 'sherlockramosreal@gmail.com')}
                className={`text-left p-2.5 rounded-xl border text-xs font-medium transition cursor-pointer flex items-center gap-2 ${
                  currentEmail === 'sherlockramosreal@gmail.com'
              ...
              >
                ...
                <div className="truncate">
                  <div className="font-bold truncate">sherlockramosreal@gmail.com</div>
                  <div className="text-[10px] text-slate-400 truncate">Kho bài học chính</div>
                </div>
              </button>

              <button
                type="button"
                id="quick-select-anhtuan-btn"
              ...
              >
                <div className="w-6 h-6 rounded-full bg-indigo-600 text-white flex items-center justify-center text-2xs font-bold shrink-0">
                  T
                </div>
                <div className="truncate">
              ...
              >
                ...
                <div className="truncate">
                  ...
                  <div className="text-[10px] text-slate-400 truncate">Kho User A</div>
                </div>
              </button>

              <button
                type="button"
                id="quick-select-guest-btn"
